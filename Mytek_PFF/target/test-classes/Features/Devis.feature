Feature: Devis
  ...
  Scenario Outline: Demander un devis de plusieurs articles
    ...
    Then Le devis doit etre genere
      ...
      | Ben.dhaya.ahmed.baha.eddine@hotmail.com | 22080023A | Asus ChromeBook | PC PORTABLE LENOVO IDEAPAD 1 11IGL05 N4020 4GO 128GO SSD - GRIS (81VT0058FG) | SMARTPHONE XIAOMI REDMI 9A 32G - BLEU |
